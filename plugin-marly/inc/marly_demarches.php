...
function marly_socle_demarches() {
	...
	return array(
		...
		array(
			...
			'comment' => 'La demande se fait sur place, par courrier ou [en ligne->https://www.service-public.gouv.fr/particuliers/vosdroits/R1406], au choix. Précisez la date de l’événement et les noms et prénoms des parents : ce sont eux qui permettent de retrouver l’acte.',
			...
			'lien_faire' => 'https://www.service-public.gouv.fr/particuliers/vosdroits/R1406',
		),
		array(
		...
		array(
			...
			'comment' => 'L’inscription se fait [en ligne->https://www.service-public.gouv.fr/particuliers/vosdroits/R16396] en quelques minutes, ou au secrétariat de la mairie si vous préférez être accompagné.',
			'a_savoir' => 'Un doute, notamment après un déménagement ? [Vérifiez en deux minutes si vous êtes déjà inscrit->https://www.service-public.gouv.fr/particuliers/vosdroits/services-en-ligne-et-formulaires/ISE], avant de refaire la démarche.',
		...
		array(
			...
			'famille' => 'enligne', 'icone' => 'ri-scales-3-line', 'rang' => 62,
			'resume'  => 'Absent le jour du vote ? Une personne de confiance peut voter à votre place, dans votre bureau de vote.',
			'qui'     => 'Tout électeur. La personne qui vote pour vous doit être inscrite sur les listes électorales, dans n’importe quelle commune.',
			'comment' => "-# Faites la demande sur [maprocuration.gouv.fr->https://www.maprocuration.gouv.fr/], ou avec le formulaire papier.\n-# Faites valider votre identité en gendarmerie ou au commissariat, avec une pièce d'identité.\n-# Le jour du vote, votre mandataire se présente à votre bureau de vote, à Marly-Gomont, et vote en votre nom.",
			'pieces'  => 'Votre pièce d’identité, et le numéro national d’électeur de votre mandataire (il figure sur sa carte électorale).',
			'cout'    => 'Gratuit',
			'delai'   => 'Possible jusqu’à la veille du scrutin, mais faites-la tôt : la validation et l’acheminement prennent quelques jours',
			'ou'      => 'En ligne puis en gendarmerie pour la validation. Le secrétariat de mairie peut vous aider à préparer la demande.',
			'a_savoir' => 'Le mandataire ne peut détenir qu’une seule procuration établie en France. Vous pouvez résilier la vôtre à tout moment, en ligne également.',
			'socle'   => 1,
			'lien'      => 'https://www.service-public.gouv.fr/particuliers/vosdroits/F1604',
			'lien_faire' => 'https://www.maprocuration.gouv.fr/',
		),
		array(
		...
		array(
			...
			'a_savoir' => 'Un titre non retiré dans les trois mois est détruit, sans remboursement. Méfiez-vous des sites payants qui imitent les sites officiels : la pré-demande et le rendez-vous sont gratuits. Avec [l’application France Identité->https://france-identite.gouv.fr/], votre nouvelle carte peut aussi prouver votre identité en ligne.',
		...
		array(
			...
			'qui'     => 'Toute personne.',
			'comment' => 'Rendez-vous sur [le site officiel du cadastre->https://www.cadastre.gouv.fr/] : cherchez la commune, puis la parcelle. La consultation et l’impression sont gratuites.',
			'pieces'  => 'Aucune.',
			'cout'    => 'Gratuit',
			'delai'   => 'Immédiat',
