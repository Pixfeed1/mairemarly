...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'bandeau_aide'     => 'Format paysage, au moins 1200 pixels de large. La bande est basse et très large : une vue dégagée du village convient mieux qu’un bâtiment cadré serré. Tant qu’aucune n’est déposée, le paysage dessiné du thème s’affiche.',
...
@site@',
	...
	'photo_manif'          => 'Photographie de l’événement',
	'photo_manif_aide'     => 'L’affiche, ou une photo de l’édition précédente. Elle s’affiche sur la page d’accueil et dans le catalogue. Facultative : sans elle, la fiche reste sobre.',
	'photo_salle'          => 'Photographie de la salle',
	'photo_salle_aide'     => 'Une vue de la salle aménagée aide beaucoup à se projeter. Facultative : sans elle, la fiche affiche une pastille aux couleurs de la commune.',
	...
	'champ_biographie'     => 'Parcours',
	'biographie_aide'      => 'Quelques lignes sur cette personne : depuis quand elle est élue, ce qu’elle a porté, ce qui lui tient à cœur. C’est ce qu’on lit en ouvrant sa fiche. Facultatif.',
	...
	'logo_aide'                 => 'Elle s’ajoute après l’enregistrement : un bloc « Photographie » apparaît alors sous ce formulaire. C’est elle qui s’affiche sur la page d’accueil et dans le catalogue.',
...
@site@',
	...
	'objets_commerces'     => 'Commerces',
	'creer_commerce'       => 'Ajouter un commerce',
	...
	'confirmer_suppression_salle' => 'Supprimer cette salle ? Les réservations qui s’y rapportent seront supprimées elles aussi.',
	'confirmer_suppression_manifestation' => 'Supprimer cet événement ? Les inscriptions déjà reçues seront supprimées elles aussi.',
	'confirmer_suppression_raccourci' => 'Supprimer ce raccourci de la page d’accueil ?',
	...
	'commerce_enregistre' => 'Enregistré.',
	'commerce_enregistre_localise' => 'Enregistré. L’adresse a été localisée : la carte apparaît sur la fiche du site.',
	'commerce_enregistre_approche' => 'Enregistré. L’adresse exacte n’a pas été reconnue : la carte est centrée sur le village, le marqueur n’est pas sur le bâtiment. Pour un repère précis, essayez le nom de la rue, par exemple « rue de l’Église ».',
	'commerce_enregistre_non_localise' => 'Enregistré, mais l’adresse n’a pas pu être localisée : la fiche paraît sans carte. Vérifiez le nom de la rue et de la commune, ou écrivez seulement la rue et le code postal.',

	// Les quatre catégories. Volontairement larges : une catégorie par métier
	// donnerait vingt catégories d’une entrée chacune.
	'cat_commerce' => 'Commerces, épicerie, alimentation',
	'cat_sante'    => 'Santé, médecins, pharmacie',
	'cat_artisan'  => 'Artisans, bâtiment, travaux',
	'cat_service'  => 'Services, hébergement, numérique',

	'champ_nom_commerce'   => 'Nom du commerce',
	'nom_commerce_aide'    => 'Le nom sous lequel les habitants le connaissent, pas la raison sociale. « Boulangerie La mie des Marlysiens » plutôt que « SARL Midelet ».',
	'champ_categorie'      => 'Catégorie',
	'categorie_aide'       => 'Elle s’affiche en étiquette au-dessus du nom. Choisissez la plus proche : mieux vaut « Services » que rien.',
	'activite_commerce_aide'  => 'Ce qu’on y trouve ou ce qu’il fait, en une ou deux phrases. « Pain, viennoiseries et pâtisserie, fabriqués sur place. »',
	'champ_responsable'    => 'Responsable',
	'responsable_aide'     => 'Le nom de la personne à qui s’adresser. Facultatif.',
	'telephone_commerce_aide' => 'Il devient cliquable sur la fiche : depuis un téléphone, on appuie dessus et l’appel part. C’est ce que les habitants viennent chercher.',
	'champ_adresse_commerce' => 'Adresse',
	'adresse_commerce_aide'  => 'La rue et le numéro. Les coordonnées de la carte en sont tirées à l’enregistrement : vous n’avez qu’une chose à écrire.',
	'horaires_commerce_aide' => 'Les jours et heures d’ouverture, écrits comme vous les diriez. « Du mardi au dimanche, de 7h à 13h. »',
	'commerce_ou_quand'    => 'Où et quand',
	'photo_commerce'       => 'Photographie',
	'photo_commerce_aide'  => 'Une photo de la devanture ou de l’équipe. Facultative : sans elle, la fiche affiche le sceau de la commune sur fond vert.',
	'col_categorie'        => 'Catégorie',
	'col_contact'          => 'Contact',

	'retour_commerces'     => 'Retour aux commerces et services',
	'commerce_ou'          => 'Où',
	'commerce_quand'       => 'Horaires',
	'commerce_site'        => 'Site internet',
	'voir_la_carte'        => 'Voir la carte du village',
	'commerce_absent'      => 'Votre commerce ne figure pas dans cette liste, ou ses coordonnées ont changé ?',
